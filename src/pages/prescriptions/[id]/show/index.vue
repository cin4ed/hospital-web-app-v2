    ...
    <form @submit.prevent="onSubmit" class="space-y-4">
      ...
      <FormField v-slot="{ componentField }" name="notes">
        <FormItem>
          ...
          <FormControl>
            <Textarea class="min-h-32" type="text" v-bind="componentField" disabled />
          </FormControl>
          <FormMessage />
        </FormItem>
      </FormField>
      ...
      <div class="flex gap-4">
        <div>
          <h1 class="font-semibold">Medicinas De la Receta</h1>
          <ul>
      ...
      <Button type="button"@click="turnBack">Regresar</Button>
    </form>
  </div>
</template>